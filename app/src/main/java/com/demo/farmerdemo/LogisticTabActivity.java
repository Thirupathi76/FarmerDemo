...
public class LogisticTabActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.AddFragment(new ColdChainTab(), "ColdChain");
        adapter.AddFragment(new TransportTab(), "Transport");
