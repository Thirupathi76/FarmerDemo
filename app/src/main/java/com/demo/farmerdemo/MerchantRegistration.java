...
public class MerchantRegistration extends AppCompatActivity implements View.OnClickListener {
...
//        ss.setSpan(new StyleSpan(Typeface.BOLD), sth.length(), sth2.length(), 0);
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View textView) {
                startActivity(new Intent(MerchantRegistration.this, MainActivity.class));
...
//                String photo_path = Constants.getPrefernce(FarmerSignUp.this, Constants.YOU_IMAGE);
                ...
                Constants.setPrefernce(MerchantRegistration.this, Constants.NAME, u_name);
                Constants.setPrefernce(MerchantRegistration.this, Constants.PASSWORD, u_password);
                Constants.setPrefernce(MerchantRegistration.this, Constants.PHONE, u_mobile);
                Constants.setPrefernce(MerchantRegistration.this, Constants.EMAIL, u_email);
                Constants.setPrefernce(MerchantRegistration.this, Constants.CITY, u_district);


                AppService service = AppApi.createAppService(MerchantRegistration.this);
                    ...
                    public void onResponse(Call<SignupResponse> call, Response<SignupResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().isErr()) {
                                startActivity(new Intent(MerchantRegistration.this, LoginActivity.class));
                                Log.e("Response ", response.body().getMsg());
                                Toast.makeText(MerchantRegistration.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Response ", response.body().getMsg());
                            Toast.makeText(MerchantRegistration.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
