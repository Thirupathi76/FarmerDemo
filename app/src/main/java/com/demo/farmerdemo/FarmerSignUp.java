...
public class FarmerSignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.farmer_signup);
...
//                String photo_path = Constants.getPrefernce(FarmerSignUp.this, Constants.YOU_IMAGE);
                ...
                Constants.setPrefernce(FarmerSignUp.this, Constants.NAME, u_name);
                Constants.setPrefernce(FarmerSignUp.this, Constants.PASSWORD, u_password);
                Constants.setPrefernce(FarmerSignUp.this, Constants.PHONE, u_mobile);
                Constants.setPrefernce(FarmerSignUp.this, Constants.EMAIL, u_email);
                Constants.setPrefernce(FarmerSignUp.this, Constants.CITY, u_district);


                AppService service = AppApi.createAppService(FarmerSignUp.this);
                    ...
                    public void onResponse(Call<SignupResponse> call, Response<SignupResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().isErr()) {
                                startActivity(new Intent(FarmerSignUp.this, LoginActivity.class));
                                Log.e("Response ", response.body().getMsg());
                                Toast.makeText(FarmerSignUp.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Response ", response.body().getMsg());
                            Toast.makeText(FarmerSignUp.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
