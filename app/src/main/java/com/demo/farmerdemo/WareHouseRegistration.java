...
public class WareHouseRegistration extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.warehouse_signup);
...
//        ss.setSpan(new StyleSpan(Typeface.BOLD), sth.length(), sth2.length(), 0);
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View textView) {
                startActivity(new Intent(WareHouseRegistration.this, MainActivity.class));
...
//                String photo_path = Constants.getPrefernce(FarmerSignUp.this, Constants.YOU_IMAGE);
                ...
                Constants.setPrefernce(WareHouseRegistration.this, Constants.NAME, u_name);
                Constants.setPrefernce(WareHouseRegistration.this, Constants.PASSWORD, u_password);
                Constants.setPrefernce(WareHouseRegistration.this, Constants.PHONE, u_mobile);
                Constants.setPrefernce(WareHouseRegistration.this, Constants.EMAIL, u_email);
                Constants.setPrefernce(WareHouseRegistration.this, Constants.CITY, u_district);


                AppService service = AppApi.createAppService(WareHouseRegistration.this);
                    ...
                    public void onResponse(Call<SignupResponse> call, Response<SignupResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().isErr()) {
                                startActivity(new Intent(WareHouseRegistration.this, LoginActivity.class));
                                Log.e("Response ", response.body().getMsg());
                                Toast.makeText(WareHouseRegistration.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Response ", response.body().getMsg());
                            Toast.makeText(WareHouseRegistration.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
