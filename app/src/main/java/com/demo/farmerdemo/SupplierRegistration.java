...
public class SupplierRegistration extends AppCompatActivity implements View.OnClickListener {
...
//        ss.setSpan(new StyleSpan(Typeface.BOLD), sth.length(), sth2.length(), 0);
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View textView) {
                startActivity(new Intent(SupplierRegistration.this, MainActivity.class));
...
//                String photo_path = Constants.getPrefernce(FarmerSignUp.this, Constants.YOU_IMAGE);
                ...
                Constants.setPrefernce(SupplierRegistration.this, Constants.NAME, u_name);
                Constants.setPrefernce(SupplierRegistration.this, Constants.PASSWORD, u_password);
                Constants.setPrefernce(SupplierRegistration.this, Constants.PHONE, u_mobile);
                Constants.setPrefernce(SupplierRegistration.this, Constants.EMAIL, u_email);
                Constants.setPrefernce(SupplierRegistration.this, Constants.CITY, u_district);


                AppService service = AppApi.createAppService(SupplierRegistration.this);
                    ...
                    public void onResponse(Call<SignupResponse> call, Response<SignupResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().isErr()) {
                                startActivity(new Intent(SupplierRegistration.this, LoginActivity.class));
                                Log.e("Response ", response.body().getMsg());
                                Toast.makeText(SupplierRegistration.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Response ", response.body().getMsg());
                            Toast.makeText(SupplierRegistration.this, "Status " + response.body().getMsg(), Toast.LENGTH_SHORT).show();
