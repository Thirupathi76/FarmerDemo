...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.MyViewHolder> {
    ...
    public CartListAdapter(Context productActivity, ArrayList<CartModel> data, ProductClickListener productClickListener) {
...
//        view.setOnClickListener(ProductNavActivity.myOnClickListener);

        return new MyViewHolder(view, productClickListener);
    }
...
//       myViewHolder.prod_image.setImageResource(images[i]);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView, final ProductClickListener listener) {
            super(itemView);
