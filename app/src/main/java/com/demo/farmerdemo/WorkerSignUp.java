...
//                String photo_path = Constants.getPrefernce(FarmerSignUp.this, Constants.YOU_IMAGE);
                ...
                Constants.setPrefernce(WorkerSignUp.this, Constants.NAME, u_name);
                Constants.setPrefernce(WorkerSignUp.this, Constants.PASSWORD, u_password);
                Constants.setPrefernce(WorkerSignUp.this, Constants.PHONE, u_mobile);
                Constants.setPrefernce(WorkerSignUp.this, Constants.EMAIL, u_email);
                Constants.setPrefernce(WorkerSignUp.this, Constants.CITY, u_city);

                startActivity(new Intent(WorkerSignUp.this, MainActivity.class));
            }*/
            startActivity(new Intent(WorkerSignUp.this, MainActivity.class));
        }
